...
\par
Given that constraint a proper definition of the arrow type class would be like the following:
...
\par
If one tries to instantiate that arrow class there are more than one issue with this approach. 
